...
df$species = df$species %>%
  ...
  str_replace_all( . , pattern = "Nyssa sinensis", 'B') %>%
  str_replace_all( . , pattern = "Quercus fabri", 'C') %>%
  str_replace_all( . , pattern = "Quercus serrata", 'D') %>%
  str_replace_all( . , pattern = "Castanopsis sclerophylla", 'E') %>%
  str_replace_all( . , pattern = "Choerospondias axillaris", 'F') %>%
  str_replace_all( . , pattern = "Sapium sebiferum", 'G') %>%
  str_replace_all( . , pattern = "Lithocarpus glaber", 'H') %>%
  str_replace_all( . , pattern = "Koelreuteria bipinnata", 'I') %>%
  str_replace_all( . , pattern = "Liquidambar formosana", 'J') %>%
  str_replace_all( . , pattern = "Sapindus mukorossi", 'K') %>%
